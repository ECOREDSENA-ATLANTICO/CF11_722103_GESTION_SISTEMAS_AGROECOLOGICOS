...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .titulo-sexto.color-acento-contenido.col-md-6.mx-auto(data-aos="fade-right")
        h5 Figura 3.
    ...
    .tarjeta.p-4.mb-5.clr--lightorange
      .row.align-items-center
        .col-lg-2
          figure
    ...
    .row
      .col-lg-12
        ImagenInfografica.color-acento-botones.mb-5.d-none.d-lg-block
          ...
          .tarjeta.p-3.px-4.shadow(y="39.5%" x="52.2%" numero="")
            p.m-0 Proceso de fermentación, maduración y fabricación (esta fase dependerá del método elegido para la producción de bioabono).
          
          .tarjeta.p-3.px-4.shadow(y="39.5%" x="77.8%" numero="")
            p.m-0 Traslado del bioabono a campo o a sitios de comercialización.

    .col-10.col-md-8.col-lg-8.mx-auto.mb-5(data-aos="fade-left")
      .tarjeta.clr--greengray.p-4
    ...
    p.mb-5.text-center Haz clic sobre cada uno de los elementos para revisar la importancia y descripción:
      ...
      .row.justify-content-around.align-items-center
        ...
        .col
          .row.justify-content-between.align-items-center
            .col.mb-3.mb-sm-0
              h4.mb-1.text-white Enlace web
              p.mb-0.text-white Construcción biofábrica.
